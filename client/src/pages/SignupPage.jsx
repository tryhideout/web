...
import { logInWithCredentials, signUpWithCredentials } from 'redux/actions/authActions';
			...
			<Center flexDirection='column' height='100vh' padding='1rem'>
				...
				<Box>
					<form onSubmit={handleSubmit}>
						...
						<Divider mt='29px' w='100%' borderWidth='1.5px' borderStyle='solid' borderRadius='5' />
					</form>
				</Box>
