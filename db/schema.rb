...
ActiveRecord::Schema[7.1].define(version: 2024_01_07_000629) do
  ...
  create_table "owners", primary_key: ["user_id", "hideout_id"], charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
